      ...
      <div className='header'>
        ...
        <form onSubmit={handleSubmit} className="search-container" style={{marginLeft: '250px', marginTop: '10px'}}>
          ...
          <div style={{display:"flex"}}>
            <span style={{overflow:"hidden", color:'white', marginLeft: '250px',width:"AuthContext",marginTop:'5px',textAlign:"right", textDecoration:'none'}}>Hello{user.name}</span> {/* 로그인한 사용자의 이름 표시 */}
